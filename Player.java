...
public class Player {
	...
	//get the size of the Card array
	...
	// the following increments, decrements, and returns the point values
	public void incrLearning(int num){
		learning = learning + num;
	}
	
	public void decrLearning(int num){
		learning = learning - num; 
	}
	
	public void incrCraft(int num){
		craft = craft + num;
	}
	
	public void decrCraft(int num){
		craft = craft - num; 
	}
	
	public void incrIntegrity(int num){
		integrity = integrity + num;
	}
	
	public void decrIntegrity(int num){
		integrity = integrity - num; 
	}
	
	public void incrQuality(int num){
		quality = quality + num;
	}
	
	public void decrQuality(int num){
		quality = quality - num; 
	}
